...
if sys.platform == "win32":
    # Get the absolute directory of the script to find the DLL
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    dll_path = os.path.join(BASE_DIR, "TeamTalk5.dll")
    ...
    try:
        ...
        # Fallback to original behavior if absolute path fails
        dll = cdll.TeamTalk5
